...
- [x] Embed `SCORING_VERSION` constant; build fails if changed without a fixture diff. (constant embedded PR #1; `scripts/check-scoring-version.sh` wired into `contract.yml` as the CI guard, session Apr-2026)
